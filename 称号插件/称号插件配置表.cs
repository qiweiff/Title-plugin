...
namespace 称号插件
{
    public class 称号插件配置表
    {
        ...
        public string 聊天格式 { get; set; } = "{前前缀}{前缀}{角色名}{后缀}{后后缀}: {聊天内容}";
        public string 聊天气泡启用时玩家名称格式 { get; set; } = "{前前缀}{前缀}{角色名}{后缀}{后后缀}";
        public bool 是否开启聊天气泡 { get; set; } = true;
        public int 称号最大字符数 { get; set; } = 13;
        public bool 是否允许管理绕过最大字符数检测 { get; set; } = true;
        public bool 是否允许无称号玩家给自己称号 { get; set; } = false;
        //public bool 是否启用多服称号同步 { get; set; } = false;
        //public List<多服同步> 同步的服务器 { get; set; } = new() { };
        ...
        public class 多服同步
        {
            ...
            public int REST端口 { get; set; } = 7878;
